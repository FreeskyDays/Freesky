...
import static com.dgensolutions.freesky.freesky.activity.RegisterActivity.INTENT_COUNTRY_CODE;
import static com.dgensolutions.freesky.freesky.activity.RegisterActivity.INTENT_PHONENUMBER;
...
public class VerificationActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback, VerificationListener {
    ...
    void createVerification(String phoneNumber, boolean skipPermissionCheck, String countryCode) {
        if (!skipPermissionCheck && ContextCompat.checkSelfPermission(this, android.Manifest.permission.READ_SMS) ==
    ...
    public void onVerified(String response) {
        ...
        showCompleted();
        setVerifiedStatus(RegisterActivity.INTENT_PHONENUMBER);
    ...
    private void setVerifiedStatus(final String phone) {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (!error) {
                            ...
                            // Error occurred in Upadation. Get the error
                            // message
