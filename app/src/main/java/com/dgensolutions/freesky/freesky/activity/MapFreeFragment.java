 ...
 */
public class MapFreeFragment extends Fragment implements OnMapReadyCallback{
   ...
   MapView mMapView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       mMapView.onCreate(savedInstanceState);
        ...
        //SupportMapFragment fragmentMap = (SupportMapFragment) getChildFragmentManager().findFragmentById(R.id.mapView);
