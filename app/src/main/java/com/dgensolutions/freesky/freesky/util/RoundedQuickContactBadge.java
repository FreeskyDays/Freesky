package com.dgensolutions.freesky.freesky.util;
...
/**
        *A rounded version of{import static android.R.attr.author;
...
public class RoundedQuickContactBadge extends QuickContactBadge {
    ...
    private void init() {
        ...
        try {
            ...
            field.set(this, getResources().getDrawable(R.drawable.quickcontact_circle));
